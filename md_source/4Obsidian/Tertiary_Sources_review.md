---
title: "Tertiary_Sources_review.md"
tags: [LiteratureReview, Bibliography, Skopos, Context, Critique]
author: "AI Assistant"
date: 2025-12-02
file_constraints: "Annotated bibliography of Theoretical (Tertiary) sources applied to AI"
---

# Technical Implementation Plan: Tertiary Source Review
- [x] **Structure**: Organize the review into three thematic clusters: Functionalism (Skopos), Linguistics (Context), and Critical Empiricism.
- [x] **Annotation Strategy**: For each source, explicitly connect the *human* theory to the *machine* reality (e.g., "Nord's Loyalty = AI Alignment").
- [x] **Selection**: Focus on the texts identified in the `Tertiary_Sources_review_table.md` (Vermeer, Nord, Halliday, Kenny, Bowker, Koehn).
- [ ] **Next Step**: Await user confirmation to proceed to the "Discussions" file.
