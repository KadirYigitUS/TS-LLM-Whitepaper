---
title: "Tertiary_Sources_review_table.md"
tags: [LiteratureReview, TranslationTheory, Skopos, Critique, Tables]
author: "AI Assistant"
date: 2025-12-02
file_constraints: "Tabular mapping of Translation Theory (Tertiary Sources) to AI concepts"
---

# Technical Implementation Plan: Tertiary Source Mapping
- [x] **Domain Bridging**: Select seminal Translation Studies (TS) texts (Vermeer, Nord, Halliday, Kenny) that offer theoretical frameworks applicable to LLM behavior.
- [x] **Topic Segmentation**: Divide the table into the three required critical vectors:
    1.  **Skopos & Prompting** (Theory of Purpose).
    2.  **Context Engineering** (Theory of Register/Situation).
    3.  **Empiric Critique** (Methodology of Evaluation).
- [x] **Pedagogical Alignment**: Ensure the "Application to LLM" column explains *how* a translator should use this theory to control or critique the AI.
- [ ] **Next Step**: This table prepares the ground for the three deep-dive files that follow.
