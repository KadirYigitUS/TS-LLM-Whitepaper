---
title: "General_Terminology.md"
tags: [Glossary, Terminology, Pedagogy, AI_Literacy]
author: "AI Assistant"
date: 2025-12-02
file_constraints: "Simplified definitions with Translation Studies analogies"
---

# Technical Implementation Plan: Terminology
- [x] **Pedagogical Strategy**: Group terms by "Layer" (Infrastructure -> Training -> Usage) rather than alphabetically, to build a mental model.
- [x] **Analogy Requirement**: Every definition must include a "Translator Equivalent" (e.g., Temperature = Creativity Knob).
- [x] **Simplicity**: Zero jargon without explanation. Math is reduced to conceptual arithmetic.
- [ ] **Final Step**: This is the last file. Request user feedback upon completion.
