---
title: "Beyond_prompt_engineering_-_What_is_Context_and_Context_Engineering.md"
tags: [Context, Halliday, RegisterTheory, RAG, Methodology]
author: "AI Assistant"
date: 2025-12-02
file_constraints: "Operationalizing 'Context' from Hallidayan theory to Vector Space"
---

# Technical Implementation Plan: Context Engineering
- [x] **Conceptual Definitions**: Distinguish between "Human Context" (World Knowledge) and "Model Context" (Token Window).
- [x] **Theoretical Framework**: Use Halliday’s *Register Theory* (Field, Tenor, Mode) as the architecture for building context prompts.
- [x] **Technique Exposition**: Explain Retrieval Augmented Generation (RAG) as "Dynamic Context Injection" using TS analogies.
- [x] **Practical Example**: Show how injecting context resolves polysemy (ambiguity) in translation.
- [ ] **Next Step**: Await user confirmation to proceed to the "Critical Empiricism" file.
